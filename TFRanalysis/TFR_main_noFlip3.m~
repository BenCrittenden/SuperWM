...
for ss = 1:7;
    ...
    conlc = squeeze(nanmean(AllSubDat(:,ss,right_ind,foi,toi),3));
    conli = squeeze(nanmean(AllSubDat(:,ss,left_ind,foi,toi),3));
    
    conrc = squeeze(nanmean(AllSubDat(:,ss+7,left_ind,foi,toi),3));
    conri = squeeze(nanmean(AllSubDat(:,ss+7,right_ind,foi,toi),3));
